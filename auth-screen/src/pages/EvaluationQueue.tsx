      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-lg shadow-lg p-6">
          ...
          <p className="text-gray-600 mb-6">
            Ideas pending review (Current role: <span className="font-semibold capitalize">{user?.role}</span>)
          </p>
          ...
          <div className="mt-6 p-4 bg-purple-50 border border-purple-200 rounded">
            <p className="text-sm text-purple-700">
              <strong>Protected Route:</strong> Only Evaluators and Admins can access this page.
              If you see this, your role has evaluation permissions.
            </p>
          </div>
        </div>
      </div>
